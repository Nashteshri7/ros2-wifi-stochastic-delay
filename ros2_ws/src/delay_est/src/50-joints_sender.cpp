...
class Sender : public rclcpp::Node {
    public:
        Sender() : Node("sender") {
            ...
            message_->name = {""};
            message_->position = std::vector<double>(50, 0.0);
            message_->velocity = std::vector<double>(50, 0.0);
            message_->effort = std::vector<double>(50, 0.0);
    ...
    private:
        ...
        static constexpr std::string_view PATH_ = "/home/ros2user/data/payload/50-joints/";
