...
class Sender : public rclcpp::Node {
    public:
        Sender(int count) : Node("sender"), count_(count) {
    ...
    private:
        ...
        void dataCollectionCallback() {
            ...
            if(log_file_.is_open()) {
                ...
                std::string file_name = "1to" + std::to_string(count_) + "/" + "receivers_to_sender.csv";
...
int main(int argc, char* argv[]) {
    for(int r = 2; r <= 10; r++) {
        ...
        auto sender_node = std::make_shared<Sender>(r);
